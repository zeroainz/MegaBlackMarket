data:extend(
        {
            ...
            { type = 'sprite',
              name = 'mbm-stg-spr',
              filename ="__MegaBlackMarket__/graphics/btn-stg.png",
              ...
              scale = 0.3 },
             { type = 'sprite',
              name = 'mbm-price-stg-spr',
              filename ="__MegaBlackMarket__/graphics/btn-price-stg.png",
              priority = 'extra-high-no-scale',
              width = 32,
              height = 32,
              flags = { 'no-crop', 'icon' },
              scale = 0.3 },--btn-price-reset-stg.png
             { type = 'sprite',
              name = 'mbm-price-stg-spr-e',
              filename ="__MegaBlackMarket__/graphics/btn-price-stg-e.png",
              priority = 'extra-high-no-scale',
              width = 32,
              height = 32,
              flags = { 'no-crop', 'icon' },
              scale = 0.3 },--
             { type = 'sprite',
              name = 'mbm-price-stg-reset-spr',
              filename ="__MegaBlackMarket__/graphics/btn-price-reset-stg.png",
              priority = 'extra-high-no-scale',
              width = 32,
              height = 32,
              flags = { 'no-crop', 'icon' },
            ...
            { type = 'sprite',
              name = 'mbm-stg-spr-e',
              filename ="__MegaBlackMarket__/graphics/btn-stg-e.png",
              priority = 'extra-high-no-scale',
              width = 32,
              height = 32,
              flags = { 'no-crop', 'icon' },
